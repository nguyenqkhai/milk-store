export const headerClass = {
  ...
  button:
    'cursor-pointer bg-gradient-to-r from-blue-500 to-blue-700 text-white px-4 py-2.5 rounded-lg font-medium shadow-md hover:shadow-lg hover:scale-105 transition duration-300 hover:from-blue-600 hover:to-blue-700',
}
